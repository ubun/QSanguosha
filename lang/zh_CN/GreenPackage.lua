...
--WEI06 鄢陵侯
	...
	["nubao"] = "怒暴",
	[":nubao"] = "锁定技，当你的武将牌被翻面后，视为你对任意一名角色使用了一张杀",
	["zhechong"] = "折冲",
...
--WU#04 谍战英豪
	...
	["diezhi"] = "谍智",
	[":diezhi"] = "沉睡技，出牌阶段，你可以和任一非主公角色更换身份牌，每阶段限一次。当阵亡角色超过2名时，你无法发动本技能直到游戏结束\
...
--WEI#07 治世之才
	...
	["quanyi"] = "劝议",
	[":quanyi"] = "出牌阶段，你可以弃一张牌并指定两名角色，前者摸取与你的体力值相等的牌数，直到你下个回合开始阶段对后者使用的【杀】和非延时锦囊(唯一目标)无效，每阶段限一次",
	["zhunsuan"] = "准算",
