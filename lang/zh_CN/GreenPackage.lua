...
--WEI05
	...
	["shixian"] = "士先",
	[":shixian"] = "你可以跳过自己的摸牌或出牌阶段并将你的武将牌翻面，每回合限一次",
...
--WU#04
	...
	["diezhi"] = "谍智",
	[":diezhi"] = "沉睡技，出牌阶段，你可以和任一非主公角色交换身份牌，每阶段限一次。当阵亡角色超过2名时，你无法发动本技能直到游戏结束\
★其他任何角色都不知道你对谁发动了谍智技能，包括被谍智的角色本身；任何角色都无法查看谍智后的身份牌，包括你自己",
	["@drig"] = "谍影",
	["fengjue"] = "封绝",
	[":fengjue"] = "天启技，你首次行动回合结束后生效：当其他角色在其回合外摸牌时，你可以弃掉一张牌，阻止其摸牌操作",
--	["fengjue"] = "封绝",
