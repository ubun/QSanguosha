...
return {
	...
	["#NiubiSelect"] = "您现在玩的是<font color=red><b>牛逼神装系列<b></font>赤壁版扩充包。 by:宇文天启<br/>%from 选择了 %arg",
	...
	["cv:tensb"] = "",
	["nongquan"] = "弄权",
	[":nongquan"] = "游戏开始时，从牌堆顶移出10张牌，称为“权”；当你濒死时，可以弃掉一张“权”牌，将体力重置为1点，并摸三张牌",
	["quan"] = "权",
	["beigong"] = "被宫",
	[":beigong"] = "锁定技，你永远跳过摸牌阶段和弃牌阶段",
	["yinfu"] = "隐伏",
	[":yinfu"] = "隐藏技，当某个条件触发后，你获得1张“权”牌，一共两次",
	["#Yinfu"] = "%from 触发了隐藏技能【隐伏】，还可以触发 %arg 次",
...
--card
	["juice_peach"] = "水桃",
	[":juice_peach"] = "出牌时机：1、出牌阶段。2、有角色处于濒死状态时<br/>
使用目标：1、任意一名已受伤角色。2、处于濒死状态的一名角色<br/>
作用效果：目标角色回复1点体力<br/>★触发连环后的效果：被连环的角色依次解除连环状态并回复1点体力",
