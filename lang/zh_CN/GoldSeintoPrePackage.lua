...
--	["gemini"] = "阿斯普洛斯",
	["gemini"] = "德弗特洛斯", 
	["disui"] = "地碎",
	[":disui"] = "出牌阶段，你使用属性【杀】时，可以规定：目标角色需连续使用两张【闪】才能抵消",
	...
	["shanyao"] = "闪耀",
	[":shanyao"] = "觉醒技，回合开始阶段，若你的体力值为1，你须减1点体力上限，若手牌数不小于体力值，永久获得技能“烈弓”；反之获得技能“不屈”",
...
★本技能还包含了一个隐藏技(*^_^*)",
	...
	["pisces"] = "雅柏菲卡", 
	["mogong"] = "魔宫",
	[":mogong"] = "每当一名其他角色使用了一张【杀】指定了一个或多个目标时，你可以展示一张梅花手牌，使该【杀】取消其余目标并更改成以你为目标（无视距离）",
	["mogongshow"] = "你可以发动【魔宫】：展示一张梅花手牌，将杀的目标指向自己",
	["#Mogong"] = "%from 发动了【%arg】，将杀的目标改为了自己",
	["jingji"] = "荆棘",
