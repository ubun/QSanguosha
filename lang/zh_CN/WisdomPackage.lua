...
--	["analeptic:ignore"] = "我是打酱油的~",
	...
	["badaoslash"] = "你可以对你攻击范围内的一名角色使用一张【杀】",
	["wenjiu"] = "温酒",
	...
	["#Yuweneffect"] = "%from 的锁定技【狱刎】被触发，死亡视为自杀",
	["shouye"] = "授业",
	[":shouye"] = "出牌阶段,你可以弃掉一张红色手牌,指定最多两名其他角色各摸一张牌",
	["jiehuo"] = "解惑",
	[":jiehuo"] = "觉醒技,当你发动【授业】目标累计超过6个时,须减去一点体力上限,并永久获得技能“师恩”:其他角色使用非延时锦囊时,（在结算前）可以让你摸一张牌",
	["#JiehuoWake"] = "%from 的觉醒技触发",
	["shien"] = "师恩",
