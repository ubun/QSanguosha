...
--WEI#03
	...
	["weighing"] = "称象",
	[":weighing"] = "锁定技，你的回合外(除游戏开始时)，每当你的手牌数不等于你的当前体力值时，你须将手牌弃至或补至等同于你当前体力值的张数",
	["kuanhou"] = "宽厚",
	[":kuanhou"] = "你每受到一次伤害，若你的武将牌正面朝上，你可将你的武将牌翻面，然后在伤害来源的回合结束时令除伤害来源外的一名角色进行一个额外的出牌阶段",
...
--SHU#03
	...
	["guolie"] = "果烈",
	[":guolie"] = "当你造成一次伤害时，可防止此伤害，改为与受伤害的角色交换全部手牌",
...
--WU#03
	...
	["liufang"] = "流放",
	[":liufang"] = "回合外，你每失去一张牌，可进行一次判定，若为黑色基本牌或黑色锦囊牌，你立即获得失去的那张牌",
...
--QUN#04
	...
	["illustrator:cyankongrong"] = "三国志大战",
	["illustrator:cyanzhangxiu"] = "Dog博士",
	["illustrator:cyanyufan"] = "三国在线",
	["illustrator:cyanpuyuan"] = "小矮米",
	["illustrator:cyanlidian"] = "",
	["illustrator:cyancaochong"] = "黑色禁药",
