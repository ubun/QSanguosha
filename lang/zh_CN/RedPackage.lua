...
--QUN#01
	...
	["liehou"] = "列侯",
	[":liehou"] = "锁定技，回合结束阶段开始时，你须令一名背面向上的角色摸一张牌；若在本回合内没有发动“同戮”，你摸一张牌",
	["tonglu:agree"] = "翻翻更健康~",
	["tonglu:deny"] = "翻你妹啊！",
...
--WU#02
	...
	["goulian"] = "媾连",
	[":goulian"] = "出牌阶段，你可以弃一张手牌并令一名男性角色回复1点体力，并在你下次行动前替你承担一次伤害。每阶段限一次",
	["@goulian"] = "媾连",
	["#GoulianDamage"] = "%from 为 %to 承担了本次的全部伤害",
